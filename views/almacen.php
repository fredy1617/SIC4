...
<div class="container">
  ...
  <table class="bordered centered highlight responsive-table">
    ...
    <tbody>
    <?php
    $sql = "SELECT * FROM dispositivos WHERE estatus = 'En Almacén' ";
  ...
  if ($filas == 0) {
    echo '<script type="text/javascript">M.toast({html:"No se encontraron dispositivos.", classes: "rounded"})</script>';
  } else {
